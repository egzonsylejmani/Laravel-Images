...
@section('content')
    <div class="max-w-md mx-auto p-4 mt-12">
        <h1 class="font-bold">Upload Pictures</h1>
        <div class="bg-slate-100 rounded-lg p-6 mt-4">
            <form method="post" action="/" enctype="multipart/form-data">
                ...
                <button type="submit"
                    class="text-white px-4 py-4 bg-blue-700 hover:bg-blue-800 focus:ring-4  focus:ring-blue-300 font-medium rounded-lg">Create
                </button>
            </form>
        </div>
    </div>
